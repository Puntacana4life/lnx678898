                  ...
                  <div className={displayMobileMenu ? "main-menu-wrap open" : "main-menu-wrap"}>
                    ...
                    <div id="menu">
                      <ul className="main-menu">
                        <li className="active">
                          <Link href="/" style={{ fontSize: "19px" }}>Home</Link>
                        </li>
                        ...
                        >
                          <a href="#" style={{ fontSize: "19px" }} onClick={toggleBlogMenu}>Blog</a>
                          ...
                          {displayBlogMenu && (
                            <ul className="sub-menu">
                              <li>
                                <Link href="/blog/Best-transportation-to-the-airport/" style={{ fontSize: "15px" }}>Best transportation to the airport</Link>
                              </li>
                              <li>
                                <Link href="/blog/Punta-cana-international-airport-to-club/" style={{ fontSize: "15px" }}>Best transportation to Club Med Resort</Link>
                              </li>
                            </ul>
                          )}
                        </li>
                        ...
                        <li>
                          <Link href="/contact-us" style={{ fontSize: "19px" }}>Contact Us</Link>
                        </li>
                        ...
                        >
                          <a href="#" style={{ fontSize: "19px" }} onClick={toggleInfoMenu}>Information</a>
                        ...
                        <li>
                          <Link href="/MyBooking" style={{ fontSize: "19px" }}>My Booking</Link>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div className="col-lg-3 col-md-6 order-lg-2 order-md-1 md-none">
                  <div className="header-bottom-right d-flex justify-content-center justify-content-md-start">
                    <div className="contact-box mr-md-3 mb-3">
                      ...
                      <p>
                        Contact Now <br />
                        <a href="tel:+18098054087">+1 (809) 805-4087</a>
                      </p>
                    </div>
