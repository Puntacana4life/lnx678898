    ...
    <div style={styles.avisoContainer}>
      <div style={styles.avisoCard}>
        <div style={styles.avisoContent}>
          <h3>Puntacana4life's Terms and Conditions</h3>
          <hr />
          <p>
            ...
            company after booking and paying to PUNTACANA4LIFE.
          </p>
          <p>
          ...
          <p>
            <strong>FLIGHT ISSUES:</strong> Contact PUNTACANA4LIFE at least 2
