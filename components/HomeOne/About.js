      ...
      <div className='container'>
        ...
        <div className='row justify-content-center mb-5'>
          <div className='col-md-10 text-center'>
            <h1 style={{ fontSize: '2.5rem', fontWeight: 'bold', marginBottom: '20px', color: '#EBB133' }}> WHY CHOOSE PUNTACANA4LIFE? </h1>
            <p style={{ fontSize: '1.2rem', lineHeight: '1.6' }}>
              When you decide to come to Punta Cana, Dominican Republic, the first thing you need to know is how to get good transportation with excellent services that are secure and safe. Our transportation offers exactly what you're looking for (PUNTACANA4LIFE).
            </p>
            <h2 style={{ fontSize: '1.2rem', lineHeight: '1.6', color: '#00ACEA' }}>Here are some reasons to choose Punta Cana Four Life for your airport transfer:</h2>
          </div>
        </div>
